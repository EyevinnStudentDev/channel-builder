      ...
      <div>
        <div className="bg-gradient-to-r from-purple-600 to-indigo-600 dark:from-purple-700 dark:to-indigo-700">
          <div className="bg-gradient-to-r from-purple-600 to-indigo-600 dark:from-purple-700 dark:to-indigo-700 relative">
            <Link
              href="/"
              className="absolute left-4 top-1/2 transform -translate-y-1/2 bg-purple-700 hover:bg-purple-600 outline text-white font-bold py-2 px-4 rounded duration-150"
            >
              Back to Start
            </Link>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-7">
          {channels.map((channel) => (
            <div className="p-2" key={channel.id}>
              <h2 className="text-center text-white font-serif text-3xl capitalize p-2">
                {channel.name}
              </h2>
