...
console.log(myChannelManager.getChannels());

// route for fetching channels
app.get('/channels', (req, res) => {
    const channels = myChannelManager.getChannels();  // Call on the instance
    res.json(channels);
});
